...
public class AddPeli extends JFrame {
    ...
    public AddPeli() {
        ...
        table.setModel(new DefaultTableModel(
            new Object[][] {},
            new String[] {
                "ID", "Nombre", "Sinopsis", "Categoría", "Idioma"
            }
        ));
        ...
        // Añadir MouseListener a la tabla para autocompletar campos al seleccionar una fila
    ...
    private void cargarPeliculas() {
        ...
        for (Pelicula pelicula : peliculas) {
            model.addRow(new Object[]{pelicula.getIdPelicula(), pelicula.getNombrePel(), pelicula.getSinopsisPel(), pelicula.getCategoriaPel(), pelicula.getIdiomaPel()});
        }
    }
    ...
    private void agregarPelicula() {
        ...
        Pelicula pelicula = new Pelicula.Builder()
            .nombrePel(nombre)
            .sinopsisPel(sinopsis)
            .categoriaPel(categoria)
            .idiomaPel(idioma)
            .build();
    ...
    private void eliminarPelicula() {
        int selectedRow = table.getSelectedRow();
        if (selectedRow == -1) {
            JOptionPane.showMessageDialog(this, "Selecciona una película para eliminar", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
