...
import com.cine.servicios.ServiciosPeliculas;
...
public class MostrarPeliculas extends JFrame {
	...
	private ServiciosPeliculasImpl servicioPelicula = null;
	...
	public MostrarPeliculas() {
		servicioPelicula = new ServiciosPeliculasImpl();
		try {
			servicioPelicula.setDbConfig(BaseDatosConexion.getInstance());
		...
		comboBox_1_1.setModel(new DefaultComboBoxModel(
				new String[] { "09:00 - 11:00", "13:00 - 15:00", "17:00 - 19:00", "21:00 - 23:00" }));
		...
		comboBox_1_2.setModel(new DefaultComboBoxModel(new String[] { "10/07/2024", "10/07/2024", "10/07/2024",
				"10/07/2024", "10/07/2024", "10/07/2024", "10/07/2024", "10/07/2024" }));
		...
		table.setModel(new DefaultTableModel(
				...
				new String[] { "ID", "Nombre", "Categor\u00EDa", "Idioma" }));
